					...
					<div className={styles.topContainer}>
						...
						<div className={styles.infoCover}>
							<div className={styles.infoContainer}>
								<p className={styles.profileTitle}> <strong>Full Name:</strong> {!buttonsToggle ? nameLine : <input type="text" placeholder={nameLine}/> }
                            	</p>
								<p className={styles.profileTitle}> <strong>Address:</strong> {!buttonsToggle ? addressLine : <input type="text" placeholder={addressLine}/> } </p>
								<p className={styles.profileTitle}><strong>Email:</strong> {!buttonsToggle ? emailLine : <input type="text" placeholder={addressLine}/> } </p>
						...
						<div className={styles.bioBox}>
                            		...
                            		<p>{!buttonsToggle ? bioLine : <textarea type="text" width="250px" height="150px" maxLength="75"/> }</p>
                        		</div>
					</div>
